...
namespace Domain.Models
{
    public class PlayerModel
    {
        ...
        //public PlayerModel(string playerCards, string playerLifeCards, string playerId, int playerPoints, int playerRoundsWins, string playerName, string playerPhotoURL)
        //{
